        ...
        <form action="{{url('admin/event')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="event_name"><span>活动名称必须填写</span>
                    </td>
                </tr>
                <tr>
                    <th><i class="require"></i>介绍</th>
                    <td>
                        <input type="text" name="event_title" class="lg">
                    </td>
                </tr>
                <tr>
                    <th>排序</th>
                    <td>
                        <input type="text" name="event_order" class="sm">
                    </td>
                </tr>
                <tr>
                    <th></th>
