		...
		<ul>
			<li>
				...
				<ul class="sub_menu">
					...
					<li><a href="{{url('admin/event/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加活动</a></li>
					<li><a href="{{url('admin/event')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>活动列表</a></li>
